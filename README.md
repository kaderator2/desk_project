...
Minimal firmware to run a standing desk controller using an ESP32, a Pololu VL53L1X ToF sensor (tight ROI for desk height), and two optocoupler-driven relays for UP/DOWN control. Integrates with ESPHome and Home Assistant.
